const n=`## 5. \`src/data/content/budgeting.md\`
\`\`\`markdown
# Budgeting & Payments
...
**Remember:** Germany is more expensive than most US cities, but salaries are generally higher and you get more benefits (healthcare, vacation, etc.). Budget carefully your first few months until you understand your true costs.`;export{n as default};
