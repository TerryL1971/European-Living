const n=`# Budapest — The Pearl of the Danube
...
*Ready to explore Budapest? Book those bath tickets, prepare for ruin bar adventures, and bring an appetite for goulash!* ♨️🍺`;export{n as default};
