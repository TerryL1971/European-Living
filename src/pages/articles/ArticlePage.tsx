                ...
                <div className="hidden lg:block prose prose-lg max-w-none text-[var(--brand-dark)]">
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      ol: ({ children, ...props }) => (
                        <ol className="list-decimal ml-6 space-y-2 my-4" {...props}>
                          {children}
                        </ol>
                      ),
                      p: ({ children, ...props }) => (
                      ...
                      strong: ({ children, ...props }) => (
                        <strong className="font-semibold text-[var(--brand-dark)]" {...props}>
                          {children}
                        </strong>
                      ),
                      a: ({ children, ...props }) => (
                        <a className="text-[var(--brand-primary)] hover:underline" {...props}>
                          {children}
                        </a>
                      ),
                      blockquote: ({ children, ...props }) => (
                        <blockquote className="border-l-4 border-[var(--brand-primary)] pl-4 italic my-4 text-[var(--brand-dark)] opacity-80" {...props}>
                          {children}
                        </blockquote>
                      ),
                    }}
